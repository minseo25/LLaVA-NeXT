...
CKPT_PATH="/vlm/LLaVA-NeXT/ckpt/kollava_onevision-google_siglip-so400m-patch14-384-Qwen_Qwen2.5-1.5B-Instruct-mlp2x_gelu-finetune-v2/checkpoint-xxxx" # this could also be the previous stage checkpoint
MID_RUN_NAME="kollava_onevision-${VISION_MODEL_VERSION_CLEAN}-${LLM_VERSION_CLEAN}-mlp2x_gelu-finetune-v3"
...
ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node="3" --nnodes="1" \
    ...
    --data_path /vlm/LLaVA-NeXT/scripts/train/stage3.yaml \
